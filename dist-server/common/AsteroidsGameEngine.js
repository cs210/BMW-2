...
var AsteroidsGameEngine = /*#__PURE__*/function (_GameEngine) {
  ...
  _createClass(AsteroidsGameEngine, [{
    ...
    key: "buildBarrier",
    value: function buildBarrier(posX, posY, sizeX, sizeY) {
      var barrier = new _Asteroid["default"](this, {}, {
        mass: 100000,
        position: new _lanceGg.TwoVector(posX, posY),
        velocity: new _lanceGg.TwoVector(0, 0),
        angularVelocity: 0
      }, new _lanceGg.TwoVector(sizeX, sizeY));
      barrier.level = 0;
    ...
    key: "addFinishLine",
    value: function addFinishLine(posX, posY) {
    ...
    key: "empty_world",
    value: function empty_world() {
      this.addFinishLine(6.5, -3.75);
    }
  }, {
    key: "one_block_world",
    value: function one_block_world() {
      this.buildBarrier(-5, 1.5, 1, 3);
      this.addFinishLine(6.5, -3.75);
    }
  }, {
    key: "over_middle_under_world",
    value: function over_middle_under_world() {
    ...
    key: "s_tunnel",
    value: function s_tunnel() {
      // Top and Bottom
      this.buildBarrier(0, 5, 11, 1);
      this.buildBarrier(0, -5, 11, 1); // Left and Right

      this.buildBarrier(5, -1, 1, 6);
      this.buildBarrier(-5, 1, 1, 6); // Middle
    ...
    key: "spiral",
    value: function spiral() {
      // Top and Bottom
      this.buildBarrier(0, 7, 11, 1);
      this.buildBarrier(0, -7, 11, 1); // Left and Right

      this.buildBarrier(6, 0, 1, 13);
      this.buildBarrier(-5, 1, 1, 6);
      this.buildBarrier(2, 0.5, 1, 3); // Middle
