...
var AsteroidsServerEngine = /*#__PURE__*/function (_ServerEngine) {
  ...
  _createClass(AsteroidsServerEngine, [{
    ...
    value: function handleCollision(evt) {
      ...
      if (A instanceof _Ship["default"] && B instanceof _Asteroid["default"]) this.gameEngine.resetShip(A);
      if (B instanceof _Ship["default"] && A instanceof _Asteroid["default"]) this.gameEngine.resetShip(B);
    ...
    value: function onPlayerConnected(socket) {
      ...
      socket.on('playerReady', function () {
        ...
        that.sendGroupUpdate(groupCode); // Check for start game
