...
var AsteroidsClientEngine = /*#__PURE__*/function (_ClientEngine) {
  ...
  function AsteroidsClientEngine(gameEngine, options) {
    ...
    if (isTouchDevice()) {
      ...
      window.addEventListener('resize', _this.resizeGame, false);
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this3.socket.on('waitingForPlayer', function () {
            ...
            $('#start-button').click(function () {
              _this3.socket.emit('playerReady'); // document.getElementById('start-button').style.visibility = 'hidden';

            });
            $('#switch-button').click(function () {
              _this3.socket.emit('playerSwitchRole');
            });
          });
