...
class Block extends Entity {
     ...
     * @param {Vector} position The position of the Block
     * @param {string} type The type of Block
     * @param {?} data Data associated with the Block
     * @param {number} duration How long the Block will last in milliseconds
     */
